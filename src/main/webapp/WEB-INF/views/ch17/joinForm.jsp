...
<div class="card m-2">
   ...
   <c:if test="${error != null}">
     ...
     <form method="post" action="join">
        ...
        <div class="form-group">
           <label for="mname">Member Password</label>
           <input type="password" class="form-control" id="mpassword" name="mpassword">
        </div>
        <div class="form-group">
           <label for="mrole">Member Role</label>
           <select class="form-control" id="mrole" name="mrole">
           		<option vlaue="ROLE_ADMIN">Admin</option>
           		<option vlaue="ROLE_MANAGER">Manager</option>
           		<option vlaue="ROLE_USER" selected>User</option>
           </select>
        </div>
